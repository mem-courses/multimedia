...
#topic("颜色查找表(LUT)", green)[
  ...
  #slide2x([34], image("../public/merged-02/0034.jpg"), image("../public/translated-02/0034.jpg"), crop: 0.92, header: false)

  #slide2x([36], image("../public/merged-02/0036.jpg"), image("../public/translated-02/0036.jpg"), header: false)

  #slide2x([37], image("../public/merged-02/0037.jpg"), image("../public/translated-02/0037.jpg"), header: false)
