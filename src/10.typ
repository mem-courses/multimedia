...
#show: project.with(
  ...
  title: link(
    "https://www.baidu.com",
    "Lecture 10. MPEG-1 Video Coding I",
  ),
  authors: (
    (
      name: "memset0",
...
#slide2x([2], image("../public/merged-10/0002.jpg"), image("../public/translated-10/0002.jpg"), crop: 0.85)

#slide2x([3], image("../public/merged-10/0003.jpg"), image("../public/translated-10/0003.jpg"), crop: 0.9)

#slide2x([5], image("../public/merged-10/0005.jpg"), image("../public/translated-10/0005.jpg"))

#slide2x([6], image("../public/merged-10/0006.jpg"), image("../public/translated-10/0006.jpg"), crop: 0.94)

#slide2x([7], image("../public/merged-10/0007.jpg"), image("../public/translated-10/0007.jpg"), header: false)

#slide2x([8], image("../public/merged-10/0008.jpg"), image("../public/translated-10/0008.jpg"), header: false)

#slide2x([9], image("../public/merged-10/0009.jpg"), image("../public/translated-10/0009.jpg"), header: false)

#slide2x([10], image("../public/merged-10/0010.jpg"), image("../public/translated-10/0010.jpg"), header: false)

#slide2x([11], image("../public/merged-10/0011.jpg"), image("../public/translated-10/0011.jpg"), crop: 0.92, header: false)

#slide2x([12], image("../public/merged-10/0012.jpg"), image("../public/translated-10/0012.jpg"), header: false)

#slide2x([13], image("../public/merged-10/0013.jpg"), image("../public/translated-10/0013.jpg"))

#slide2x([14], image("../public/merged-10/0014.jpg"), image("../public/translated-10/0014.jpg"), crop: 0.72, header: false)

#slide2x([15], image("../public/merged-10/0015.jpg"), image("../public/translated-10/0015.jpg"), header: false)

#slide2x([16], image("../public/merged-10/0016.jpg"), image("../public/translated-10/0016.jpg"), header: false)

#slide2x([17], image("../public/merged-10/0017.jpg"), image("../public/translated-10/0017.jpg"), header: false)

#slide2x([18], image("../public/merged-10/0018.jpg"), image("../public/translated-10/0018.jpg"), header: false)

#slide2x([19], image("../public/merged-10/0019.jpg"), image("../public/translated-10/0019.jpg"), header: false)

#slide2x([20], image("../public/merged-10/0020.jpg"), image("../public/translated-10/0020.jpg"))

#slide2x([21], image("../public/merged-10/0021.jpg"), image("../public/translated-10/0021.jpg"), header: false)
